"""
model_v3_residual.py — identical to model_v3.py with one change:
    from ode_v3_residual import ...   (was: from ode_v3 import ...)
"""
...
from ode_v3_residual     import CardiacODEClassifier, geodesic_deviation   # ← only change
